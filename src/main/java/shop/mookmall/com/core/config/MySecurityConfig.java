package shop.mookmall.com.core.config;
...
import shop.mookmall.com.core.auth.jwt.MyJwtAuthorizationFilter;
import shop.mookmall.com.core.exception.Exception401;
import shop.mookmall.com.core.exception.Exception403;
import shop.mookmall.com.core.util.MyFilterResponseUtil;
...
public class MySecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests(
                authorize -> authorize
                        .antMatchers("/auth/**").access("hasRole('CUSTOMER') or hasRole('SELLER')")
                        .antMatchers("/admin/**").hasRole("SELLER")
